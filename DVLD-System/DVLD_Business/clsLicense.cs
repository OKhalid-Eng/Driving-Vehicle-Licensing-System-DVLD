    ...
    public class clsLicense
    {
       ...
       // public clsDetainedLicense DetainedInfo { set; get; }
...

        {
            ...
            this.LicenseClassInfo = clsLicenseClass.FindLicenseClassByID(this.LicenseClassID);
        ...
        //    Application.PaidFees =Convert.ToDecimal(clsAppTypes.Find((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).AppFees);
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            NewLicense.PaidFees = Convert.ToSingle(this.LicenseClassInfo.ClassFees);
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.AppStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = Convert.ToDecimal(clsAppTypes.Find(Application.ApplicationTypeID).AppFees);
            Application.CreatedByUserID = CreatedByUserID;
